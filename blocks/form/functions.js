    ...
    fetch("https://writing-dimly-spout.ngrok-free.dev/generate-email-otp", {
      ...
      .then(response => {
        ...
        if (response.success === true) {
          ...
          showField("work_email_otp", true);
          showField("work_email_submit", true);
          ...
          const otpInput =
            document.querySelector('input[name="work_email_otp"]');
...
function setWorkEmailResponse(message) {
  ...
  const responseField =
    document.querySelector('[name="work_email_response"]');
